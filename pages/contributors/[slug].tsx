...
function ContributorPage({
  ...
  const thumbnailUrl = getMediaURL(
    contributor?.featured?.profile_image?.formats?.thumbnail?.url || contributor?.featured?.profile_image?.url
  )
  ...
  return (
    <Layout navigation={navigation}>
      ...
      <section className="text-center py-4">
        ...
        {isFeatured && (
          <p
            className="text-center py-2 leading-tight mt-8 lg:w-4/6 lg:mx-auto"
            dangerouslySetInnerHTML={{
              __html: contributor?.featured?.description,
            }}
          />
        )}
      </section>
